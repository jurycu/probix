...
//+kubebuilder:rbac:groups=ferulax.jurycu.io,resources=probixes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ferulax.jurycu.io,resources=probixes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ferulax.jurycu.io,resources=probixes/finalizers,verbs=update
